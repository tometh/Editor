  ...
  class MyNav extends HTMLElement {
    ...
    `
      ...
      if (LANG === 'en') {
        ...
        &nbsp;
        <a href="https://github.com/tometh/Editor/tree/master/packages/editor/demo">Source</a>
      `
      } else {
        rightContainer.innerHTML = `
        <a href="https://www.wangeditor.com/">文档</a>
        &nbsp;
        <a href="https://github.com/tometh/Editor/tree/master/packages/editor/demo">源码</a>
      `
      }
...
const MENU_CONF = [
  ...
  },
  {
    'zh-CN': {
      text: 'Shadow DOM',
      link: 'https://github.com/tometh/Editor/blob/master/packages/editor/examples/shadow-dom.html',
    },
    en: {
      text: 'Shadow DOM',
      link: 'https://github.com/tometh/Editor/blob/master/packages/editor/examples/shadow-dom.html',
